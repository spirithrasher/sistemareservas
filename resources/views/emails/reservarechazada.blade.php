                    ...
                    <table border="1">
                        <tr>
                            <th class="header" bgcolor="#0A72B5" style="height: 60px;text-align: center;" colspan="2">
                                <font style="color: white; font-size: x-large;" >Reserva Rechazada</font>
                            </th>
                        </tr>
                        <tr>
                            <td colspan="2"><p>Se rechazo la reserva creada por: <strong>{{ $reserva->solicitante->name }}</strong> </p></td>
                        </tr>
                        <tr>
